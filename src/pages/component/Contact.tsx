          ...
          <div className="container mx-auto">
            ...
            <div className="flex flex-row sm:hidden pt-[60px] w-full">
              ...
              <div className="w-[calc(50%-6%)] px-[4%]">
                ...
                <ul className="text-[16px] text-left">
                  <li className="mb-[29px]"><Link to="/termsAndconditions" className="hover:text-white">T&C</Link></li>
                  <li className="mb-[29px]"><Link to="/privacy" className="hover:text-white">Privacy Policy</Link></li>
